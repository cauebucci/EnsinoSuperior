...
SQLALCHEMY_DATABASE_URL = 'mysql+pymysql://root:root@localhost:3306/ensino_superior'
...
def carregarFaculdades():
    ...
    for chunk in  pd.read_csv('dados/MICRODADOS_CADASTRO_IES_2021.CSV', sep=';',encoding='ISO-8859-1', low_memory=False, usecols= columns, chunksize=100000):
...
def carregarCursos():
    ...
    for chunk in  pd.read_csv('dados/MICRODADOS_CADASTRO_CURSOS_2021.CSV', sep=';',encoding='ISO-8859-1', low_memory=False, usecols= columns, chunksize=100000):
